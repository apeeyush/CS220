...
namespace bluesim
{
  ...
  class MOD_mkCop : public Module {
   ...
   /* Module state */
   public:
    MOD_Reg<tUInt64> INST_copFifo_data;
    ...
    MOD_Wire<tUInt64> INST_copFifo_tempData_dummy;
    MOD_Reg<tUInt8> INST_copFifo_tempData_dummy2;
    MOD_Reg<tUInt8> INST_copFifo_tempData_dummy2_1;
    MOD_Wire<tUInt64> INST_copFifo_tempData_dummy_1;
    MOD_Wire<tUInt64> INST_copFifo_tempData_dummy_2;
    MOD_Wire<tUInt64> INST_copFifo_tempData_dummy_3;
    MOD_Wire<tUInt64> INST_copFifo_tempData_lat;
   ...
   public:
    tUInt8 DEF_copFifo_deqEn_rl__h6792;
    tUInt8 DEF_copFifo_enqEn_rl__h5191;
    tUInt8 DEF_copFifo_deqEn_dummy2_2__h10863;
    tUInt8 DEF_copFifo_enqEn_dummy2_2__h9360;
   
   /* Local definitions */
   private:
    tUInt8 DEF_IF_copFifo_tempEnqP_lat_whas__1_THEN_copFifo_t_ETC___d183;
    tUInt8 DEF_IF_copFifo_tempEnqP_lat_whas__1_THEN_NOT_copFi_ETC___d180;
    tUInt8 DEF_copFifo_deqEn_lat_1_whas____d208;
    tUInt8 DEF_copFifo_enqEn_lat_1_whas____d206;
    tUInt64 DEF_ab__h7895;
    tUInt64 DEF_ab__h7891;
    tUInt32 DEF__read__h12626;
    tUInt32 DEF__read__h110;
    tUInt8 DEF_copFifo_tempEnqP_rl___d202;
    tUInt8 DEF_copFifo_tempEnqP_lat_wget____d203;
    tUInt8 DEF_upd__h15151;
    tUInt8 DEF_upd__h9983;
    tUInt8 DEF_upd__h10016;
    tUInt8 DEF_upd__h13368;
    tUInt8 DEF_upd__h9703;
    tUInt8 DEF_upd__h9736;
    tUInt8 DEF_copFifo_tempEnqP_lat_whas____d209;
    tUInt8 DEF_copFifo_deqEn_lat_1_wget____d200;
    tUInt8 DEF_copFifo_deqEn_lat_whas____d207;
    tUInt8 DEF_copFifo_deqEn_lat_wget____d199;
    tUInt8 DEF_copFifo_enqEn_lat_1_wget____d198;
    tUInt8 DEF_copFifo_enqEn_lat_whas____d205;
    tUInt8 DEF_copFifo_enqEn_lat_wget____d197;
    tUInt8 DEF_copFifo_deqP_dummy2_2__h9944;
    tUInt8 DEF_copFifo_enqP_dummy2_2__h9664;
    tUInt8 DEF_copFifo_tempEnqP_lat_wget__2_BITS_2_TO_0___d196;
    tUInt8 DEF_copFifo_tempEnqP_rl_4_BIT_3___d213;
    tUInt8 DEF_copFifo_tempEnqP_lat_wget__2_BIT_3___d212;
    tUInt64 DEF_IF_copFifo_tempData_lat_whas__3_THEN_copFifo_t_ETC___d181;
    tUInt8 DEF_IF_copFifo_tempEnqP_lat_whas__1_THEN_copFifo_t_ETC___d195;
    tUInt8 DEF_IF_copFifo_deqP_lat_1_whas__3_THEN_copFifo_deq_ETC___d193;
    tUInt8 DEF_IF_copFifo_enqP_lat_1_whas_THEN_copFifo_enqP_l_ETC___d191;
