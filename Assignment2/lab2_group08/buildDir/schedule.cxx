...
namespace bluesim
{
  ...
  static MOD_mkSignedTb *mkSignedTb_instance = NULL;
  ...
  {
    MOD_mkSignedTb &INST_top = *mkSignedTb_instance;
    tUInt8 DEF_INST_top_DEF_mult_mul_i_EQ_16___d2;
    tUInt8 DEF_INST_top_DEF_mult_i_70_EQ_0___d271;
    tUInt8 DEF_INST_top_DEF_randomVal1_init__h4719;
    tUInt8 DEF_INST_top_DEF_randomVal2_init__h4833;
    tUInt8 DEF_INST_top_DEF_f_enqEn_dummy2__h18408;
    tUInt8 DEF_INST_top_DEF_f_enqEn_dummy2_1__h18420;
    tUInt8 DEF_INST_top_DEF_f_deqEn_dummy2__h19190;
    tUInt8 DEF_INST_top_DEF_f_deqEn_dummy2_1__h19202;
    tUInt32 DEF_INST_top_DEF__read__h4453;
    tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_mult_mul_mulStep;
    tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_mult_mul_mulStep;
    ...
    INST_top.DEF_f_deqEn_dummy2_2__h15599 = INST_top.INST_f_deqEn_dummy2_2.METH_read();
    DEF_INST_top_DEF__read__h4453 = INST_top.INST_mult_i.METH_read();
    INST_top.DEF_x__h20059 = INST_top.INST_deqCount.METH_read();
    INST_top.DEF__read__h240 = INST_top.INST_mult_mul_i.METH_read();
    INST_top.DEF_f_deqEn_rl__h11528 = INST_top.INST_f_deqEn_rl.METH_read();
    DEF_INST_top_DEF_f_deqEn_dummy2_1__h19202 = INST_top.INST_f_deqEn_dummy2_1.METH_read();
    DEF_INST_top_DEF_f_deqEn_dummy2__h19190 = INST_top.INST_f_deqEn_dummy2.METH_read();
    DEF_INST_top_DEF_mult_i_70_EQ_0___d271 = DEF_INST_top_DEF__read__h4453 == 0u;
    DEF_INST_top_DEF_mult_mul_i_EQ_16___d2 = (INST_top.DEF__read__h240) == (tUInt8)16u;
    DEF_INST_top_DEF_CAN_FIRE_RL_deq = (DEF_INST_top_DEF_mult_mul_i_EQ_16___d2 && (DEF_INST_top_DEF_mult_i_70_EQ_0___d271 && ((DEF_INST_top_DEF_f_deqEn_dummy2__h19190 && DEF_INST_top_DEF_f_deqEn_dummy2_1__h19202) && INST_top.DEF_f_deqEn_dummy2_2__h15599 ? INST_top.DEF_f_deqEn_rl__h11528 : INST_top.DEF_f_deqEn_rl__h11528))) && (INST_top.DEF_x__h20059) < 12u;
    DEF_INST_top_DEF_WILL_FIRE_RL_deq = DEF_INST_top_DEF_CAN_FIRE_RL_deq;
    INST_top.DEF_f_enqEn_dummy2_2__h14096 = INST_top.INST_f_enqEn_dummy2_2.METH_read();
    INST_top.DEF_x__h19110 = INST_top.INST_enqCount.METH_read();
    INST_top.DEF_f_enqEn_rl__h9927 = INST_top.INST_f_enqEn_rl.METH_read();
    DEF_INST_top_DEF_f_enqEn_dummy2_1__h18420 = INST_top.INST_f_enqEn_dummy2_1.METH_read();
    DEF_INST_top_DEF_f_enqEn_dummy2__h18408 = INST_top.INST_f_enqEn_dummy2.METH_read();
    DEF_INST_top_DEF_randomVal2_init__h4833 = INST_top.INST_randomVal2_init.METH_read();
    DEF_INST_top_DEF_randomVal1_init__h4719 = INST_top.INST_randomVal1_init.METH_read();
    DEF_INST_top_DEF_CAN_FIRE_RL_enq = (!DEF_INST_top_DEF_mult_i_70_EQ_0___d271 && (DEF_INST_top_DEF_mult_mul_i_EQ_16___d2 && (DEF_INST_top_DEF_randomVal1_init__h4719 && (DEF_INST_top_DEF_randomVal2_init__h4833 && ((DEF_INST_top_DEF_f_enqEn_dummy2__h18408 && DEF_INST_top_DEF_f_enqEn_dummy2_1__h18420) && INST_top.DEF_f_enqEn_dummy2_2__h14096 ? INST_top.DEF_f_enqEn_rl__h9927 : INST_top.DEF_f_enqEn_rl__h9927))))) && (INST_top.DEF_x__h19110) < 12u;
    ...
    DEF_INST_top_DEF_CAN_FIRE_RL_fin = (INST_top.DEF_x__h20059) == 12u;
    DEF_INST_top_DEF_WILL_FIRE_RL_fin = DEF_INST_top_DEF_CAN_FIRE_RL_fin;
    DEF_INST_top_DEF_CAN_FIRE_RL_mult_mul_mulStep = !DEF_INST_top_DEF_mult_mul_i_EQ_16___d2;
    DEF_INST_top_DEF_WILL_FIRE_RL_mult_mul_mulStep = DEF_INST_top_DEF_CAN_FIRE_RL_mult_mul_mulStep;
    DEF_INST_top_DEF_CAN_FIRE_RL_randomVal2_initialize = !DEF_INST_top_DEF_randomVal2_init__h4833;
    DEF_INST_top_DEF_WILL_FIRE_RL_randomVal2_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomVal2_initialize;
    DEF_INST_top_DEF_CAN_FIRE_RL_randomVal1_initialize = !DEF_INST_top_DEF_randomVal1_init__h4719;
    ...
    if (DEF_INST_top_DEF_WILL_FIRE_RL_fin)
      INST_top.RL_fin();
    if (DEF_INST_top_DEF_WILL_FIRE_RL_mult_mul_mulStep)
      INST_top.RL_mult_mul_mulStep();
    ...
    if (do_reset_ticks())
    {
      INST_top.INST_mult_mul_i.rst_tick__clk__1((tUInt8)1u);
  ...
  void create_model(bool master)
  {
    ...
    mkSignedTb_instance = new MOD_mkSignedTb("top", NULL);
    ...
    (mkSignedTb_instance->INST_f_enqP_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_lat_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_4.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_5.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_6.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_7.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqP_dummy_8.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_lat_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_4.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_5.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_6.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_7.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqP_dummy_8.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_lat_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_4.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_5.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_6.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_7.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_enqEn_dummy_8.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_lat_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_4.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_5.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_6.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_7.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_deqEn_dummy_8.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempData_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_lat.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_lat_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_dummy.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_dummy_1.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_dummy_2.set_clk_0)("CLK");
    (mkSignedTb_instance->INST_f_tempEnqP_dummy_3.set_clk_0)("CLK");
    (mkSignedTb_instance->set_clk_0)("CLK");
  }
  void destroy_model()
  {
    delete mkSignedTb_instance;
    mkSignedTb_instance = NULL;
  }
  void reset_model(bool asserted)
  {
    (mkSignedTb_instance->reset_RST_N)(asserted ? (tUInt8)0u : (tUInt8)1u);
  }
  void * get_instance()
  {
    return mkSignedTb_instance;
  }
  ...
  time_t get_creation_time()
  {
    ...
    /* Sun Feb  2 10:28:49 UTC 2014 */
    return 1391336929llu;
  }
  ...
  void dump_state()
  {
    (mkSignedTb_instance->dump_state)(0u);
  }
  
  /* VCD dumping functions */
  MOD_mkSignedTb & mkSignedTb_backing()
  {
    static MOD_mkSignedTb *instance = NULL;
    if (instance == NULL)
    {
      vcd_set_backing_instance(true);
      instance = new MOD_mkSignedTb("top", NULL);
  ...
  void dump_VCD_defs()
  {
    (mkSignedTb_instance->dump_VCD_defs)(vcd_depth);
  }
  void dump_VCD(tVCDDumpType dt)
  {
    (mkSignedTb_instance->dump_VCD)(dt, vcd_depth, mkSignedTb_backing());
  }
}
