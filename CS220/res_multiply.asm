# Main function for multiply.asm
...
main:
	...
	# $s0 save the input list HEAD for a
	jal     list_create
	move    $s0, $v0
...
# sequence for creation of i/p list b        
main_fwd_a:	
	# $s2 save the input list HEAD for a
	jal     list_create
	move    $s2, $v0
...
.data
print_msg: .asciiz "\nEnter two numbers to be multiplied:\nAfter each digit press ENTER. Input ends when a non-digit number is entered.\n"
