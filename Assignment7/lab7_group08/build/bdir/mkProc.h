...
namespace bluesim
{
  ...
  class MOD_mkProc : public Module {
   ...
   public:
    tUInt8 DEF_cop_started____d367;
   
   /* Local definitions */
   private:
    tUWide DEF_exec___d366;
    tUWide DEF_decode_05_BITS_64_TO_54_06_CONCAT_decode_05_BI_ETC___d323;
    tUInt32 DEF_pc___d360;
    tUWide DEF_decode___d375;
    tUWide DEF_NOT_exec_31_BITS_76_TO_73_32_EQ_2_34_37_CONCAT_ETC___d344;
