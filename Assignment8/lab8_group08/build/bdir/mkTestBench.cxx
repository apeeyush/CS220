...
namespace bluesim
{
  ...
  {
    tUInt32 DEF_x__h257;
    tUInt32 DEF__read__h103;
    DEF__read__h103 = INST_cycle.METH_read();
    DEF_x__h257 = DEF__read__h103 + 1u;
    INST_cycle.METH_write(DEF_x__h257);
    if (!(PORT_RST_N == (tUInt8)0u))
      dollar_display(this, "s,32", &__str_literal_1, DEF__read__h103);
  }
  ...
  void MOD_mkTestBench::RL_run()
  {
    ...
    tUInt8 DEF_idx__h306;
    tUInt32 DEF_data__h307;
    tUInt64 DEF_ab__h299;
    tUInt64 DEF_AVMeth_proc_cpuToHost;
    DEF_AVMeth_proc_cpuToHost = INST_proc.METH_cpuToHost();
    DEF_ab__h299 = DEF_AVMeth_proc_cpuToHost;
    DEF_data__h307 = (tUInt32)(DEF_ab__h299);
    DEF_idx__h306 = (tUInt8)(DEF_ab__h299 >> 32u);
    DEF_proc_cpuToHost_BITS_31_TO_0_2_EQ_0___d15 = DEF_data__h307 == 0u;
    DEF_proc_cpuToHost_BITS_36_TO_32_0_EQ_21___d14 = DEF_idx__h306 == (tUInt8)21u;
    DEF_proc_cpuToHost_BITS_36_TO_32_0_EQ_19___d13 = DEF_idx__h306 == (tUInt8)19u;
    DEF_proc_cpuToHost_BITS_36_TO_32_0_EQ_18___d11 = DEF_idx__h306 == (tUInt8)18u;
	...
	dollar_fwrite(this, "32,s,32", 2147483650u, &__str_literal_2, DEF_data__h307);
      if (DEF_proc_cpuToHost_BITS_36_TO_32_0_EQ_19___d13)
	dollar_fwrite(this, "32,s,32", 2147483650u, &__str_literal_3, DEF_data__h307);
	...
	dollar_fwrite(this, "32,s,32", 2147483650u, &__str_literal_5, DEF_data__h307);
